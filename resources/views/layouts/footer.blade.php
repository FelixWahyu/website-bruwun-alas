<footer class="bg-gray-900 text-white border-t-4 border-red-600">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">

            <div class="space-y-4">
                <a href="{{ route('home') }}" class="flex items-center gap-2 group">
                    <div class="w-8 h-8 bg-red-50 rounded-lg flex items-center justify-center text-white shadow-lg">
                        <img src="{{ asset('img/logo-ba.webp') }}" class="w-full h-full object-cover"
                            alt="logo-bruwun-alas">
                    </div>
                    <span class="text-2xl font-bold text-white tracking-tight">
                        Bruwun<span class="text-red-500">Alas</span>
                    </span>
                </a>
                ...
                <div class="flex space-x-4 pt-2">
                    ...
                    <a href="#"
                        ...
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93v6.14c0 3.48-2.32 5.79-5.49 6.34-4.45.77-8.39-2.51-8.35-7.14.04-2.24 1.17-4.09 3.07-5.13 1.95-1.07 4.31-.99 6.13.35v4.02c-1.45-1.73-4.59-1.29-5.43.89-.66 1.7 1.08 3.53 2.91 3.07 1.18-.3 1.92-1.28 1.92-2.48v-14.13z" />
                        </svg>
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm text-gray-400">
                    <li class="flex items-start">
                        ...
                        <span>Jl. Jend. Sudirman No.296, Pereng, Sokanegara, Kec. Purwokerto Tim., Kabupaten Banyumas,
                            Jawa Tengah 53116</span>
                    </li>
            ...
            <div>
                ...
                <form action="#" class="flex flex-col gap-2">
                    <input type="email" placeholder="Masukkan Email Anda"
                        class="bg-gray-800 text-white text-sm px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 border border-gray-700">
                    <button type="submit"
                        class="bg-red-600 text-white text-sm font-bold px-4 py-3 rounded-lg hover:bg-red-700 transition shadow-lg">
                        Langganan
                    </button>
                </form>
            </div>
